...
def do_everything(root_folder, url, num_videos=5, resolution='1080p',
                  ...
                  asr_method='WhisperX', whisper_model='large-v2', batch_size=32, diarization=False, whisper_min_speakers=1, whisper_max_speakers=5, 
                  translation_method = 'OpenAI',translation_target_language='English', 
                  tts_method='xtts', tts_target_language='English', voice='zh-CN-XiaoxiaoNeural',
